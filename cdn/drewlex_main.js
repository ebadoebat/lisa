...
function initFeatures(settings) {
    ...
    if (!settings.formApi || !settings.formApi.isNeeded) {
        var featuresFilesSrc = (window.location.protocol == 'file:') ? {
                 userAva: 'cdn/img/autoCommentsAva.jpg',
            refreshingArrow: 'cdn/img/autoCommentsRefreshing.gif',
            autoCommStyles: 'cdn/css/autoComments.css',
            popupsStyles: 'cdn/css/popups.css',
            popupsIconUser: 'cdn/img/count-user_black.png',
            popupsIconOrder: 'cdn/img/count-order-984_black.png',
            prizeWheel: 'cdn/img/prizewheel.png',
            wheelCursor: 'cdn/img/wheel-cursor.png',
            wheelStyles: 'cdn/css/wheel.css',
            formStyles: 'cdn/css/formStyles.css'
        } : {
                 userAva: 'cdn/img/autoCommentsAva.jpg',
            refreshingArrow: 'cdn/img/autoCommentsRefreshing.gif',
            autoCommStyles: 'cdn/css/autoComments.css',
...
var priceMain = ' ' + settings.priceMain;
var currencyMain = ' ' + settings.currencyMain;        
    } else {
        var priceMain = ' ' + settings.priceMain;
        var currencyMain = ' ' + settings.currencyMain;        
    }
